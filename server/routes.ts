  ...
  app.get("/api/seed-trending", async (req, res) => {
    ...
    const run = async () => {
      try {
        ...
        const curatedBase: { query: string; aesthetic: string }[] = [
          // ── Streetwear (23) ──
          ...
          { query: "streetwear baggy jeans", aesthetic: "Streetwear" },
          { query: "streetwear bomber jacket", aesthetic: "Streetwear" },
          { query: "streetwear joggers", aesthetic: "Streetwear" },
          { query: "streetwear nike sneakers", aesthetic: "Streetwear" },
          { query: "streetwear jordan sneakers", aesthetic: "Streetwear" },
          { query: "streetwear bucket hat", aesthetic: "Streetwear" },
          { query: "streetwear puffer jacket", aesthetic: "Streetwear" },
          { query: "streetwear vintage tee", aesthetic: "Streetwear" },
          { query: "streetwear balaclava", aesthetic: "Streetwear" },
          { query: "streetwear adidas tracksuit", aesthetic: "Streetwear" },
          { query: "streetwear zip up hoodie", aesthetic: "Streetwear" },
          { query: "streetwear cargos", aesthetic: "Streetwear" },
          { query: "streetwear windbreaker", aesthetic: "Streetwear" },
          { query: "streetwear snap back cap", aesthetic: "Streetwear" },
          { query: "streetwear chunky sneakers", aesthetic: "Streetwear" },
          { query: "streetwear denim jacket", aesthetic: "Streetwear" },
          { query: "streetwear utility pants", aesthetic: "Streetwear" },
          { query: "streetwear long sleeve", aesthetic: "Streetwear" },
          { query: "streetwear sweatpants", aesthetic: "Streetwear" },
          { query: "streetwear crewneck sweatshirt", aesthetic: "Streetwear" },
          // ── Minimalist (23) ──
          ...
          { query: "minimalist slip dress", aesthetic: "Minimalist" },
          { query: "minimalist blazer beige", aesthetic: "Minimalist" },
          { query: "minimalist tote bag", aesthetic: "Minimalist" },
          { query: "minimalist crew neck", aesthetic: "Minimalist" },
          { query: "minimalist straight leg jeans", aesthetic: "Minimalist" },
          { query: "minimalist black trousers", aesthetic: "Minimalist" },
          { query: "minimalist ribbed tank", aesthetic: "Minimalist" },
          { query: "minimalist midi skirt", aesthetic: "Minimalist" },
          { query: "minimalist oversized shirt", aesthetic: "Minimalist" },
          { query: "minimalist boxy tee", aesthetic: "Minimalist" },
          { query: "minimalist loafers", aesthetic: "Minimalist" },
          { query: "minimalist trench coat", aesthetic: "Minimalist" },
          { query: "minimalist mock neck", aesthetic: "Minimalist" },
          { query: "minimalist linen pants", aesthetic: "Minimalist" },
          { query: "minimalist white button up", aesthetic: "Minimalist" },
          { query: "minimalist silk top", aesthetic: "Minimalist" },
          { query: "minimalist column dress", aesthetic: "Minimalist" },
          { query: "minimalist leather belt", aesthetic: "Minimalist" },
          { query: "minimalist knit vest", aesthetic: "Minimalist" },
          { query: "minimalist neutral cardigan", aesthetic: "Minimalist" },
          // ── Y2K (23) ──
          ...
          { query: "y2k rhinestone top", aesthetic: "Y2K" },
          { query: "y2k platform boots", aesthetic: "Y2K" },
          { query: "y2k mini skirt", aesthetic: "Y2K" },
          { query: "y2k velour tracksuit", aesthetic: "Y2K" },
          { query: "y2k denim skirt", aesthetic: "Y2K" },
          { query: "y2k bedazzled top", aesthetic: "Y2K" },
          { query: "y2k halter top", aesthetic: "Y2K" },
          { query: "y2k tube top", aesthetic: "Y2K" },
          { query: "y2k trucker hat", aesthetic: "Y2K" },
          { query: "y2k crossbody bag", aesthetic: "Y2K" },
          { query: "y2k juicy couture", aesthetic: "Y2K" },
          { query: "y2k mesh top", aesthetic: "Y2K" },
          { query: "y2k wrap dress", aesthetic: "Y2K" },
          { query: "y2k cowl neck top", aesthetic: "Y2K" },
          { query: "y2k flare jeans", aesthetic: "Y2K" },
          { query: "y2k chunky belt", aesthetic: "Y2K" },
          { query: "y2k zip hoodie", aesthetic: "Y2K" },
          { query: "y2k printed pants", aesthetic: "Y2K" },
          { query: "y2k crop jacket", aesthetic: "Y2K" },
          // ── Preppy (23) ──
          ...
          { query: "preppy blazer stripe", aesthetic: "Preppy" },
          { query: "preppy loafers", aesthetic: "Preppy" },
          { query: "preppy headband", aesthetic: "Preppy" },
          { query: "preppy boat shoes", aesthetic: "Preppy" },
          { query: "preppy chino pants", aesthetic: "Preppy" },
          { query: "preppy cardigan argyle", aesthetic: "Preppy" },
          { query: "preppy tennis skirt", aesthetic: "Preppy" },
          { query: "preppy button down oxford", aesthetic: "Preppy" },
          { query: "preppy knit vest", aesthetic: "Preppy" },
          { query: "preppy navy blazer", aesthetic: "Preppy" },
          { query: "preppy madras shirt", aesthetic: "Preppy" },
          { query: "preppy bermuda shorts", aesthetic: "Preppy" },
          { query: "preppy plaid blazer", aesthetic: "Preppy" },
          { query: "preppy ribbon belt", aesthetic: "Preppy" },
          { query: "preppy puffer vest", aesthetic: "Preppy" },
          { query: "preppy peter pan collar", aesthetic: "Preppy" },
          { query: "preppy varsity jacket", aesthetic: "Preppy" },
          { query: "preppy ruffle blouse", aesthetic: "Preppy" },
          { query: "preppy pleated trousers", aesthetic: "Preppy" },
          { query: "preppy seersucker shirt", aesthetic: "Preppy" },
          // ── Dark Academia (23) ──
          ...
          { query: "dark academia oxfords", aesthetic: "Dark Academia" },
          { query: "dark academia knit sweater", aesthetic: "Dark Academia" },
          { query: "dark academia midi skirt", aesthetic: "Dark Academia" },
          { query: "dark academia vest", aesthetic: "Dark Academia" },
          { query: "dark academia plaid skirt", aesthetic: "Dark Academia" },
          { query: "dark academia button down", aesthetic: "Dark Academia" },
          { query: "dark academia cape", aesthetic: "Dark Academia" },
          { query: "dark academia corduroy pants", aesthetic: "Dark Academia" },
          { query: "dark academia leather satchel", aesthetic: "Dark Academia" },
          { query: "dark academia long cardigan", aesthetic: "Dark Academia" },
          { query: "dark academia lace up boots", aesthetic: "Dark Academia" },
          { query: "dark academia pinstripe", aesthetic: "Dark Academia" },
          { query: "dark academia waistcoat", aesthetic: "Dark Academia" },
          { query: "dark academia loafers", aesthetic: "Dark Academia" },
          { query: "dark academia beret", aesthetic: "Dark Academia" },
          { query: "dark academia wool coat", aesthetic: "Dark Academia" },
          { query: "dark academia suspenders", aesthetic: "Dark Academia" },
          { query: "dark academia pleated skirt", aesthetic: "Dark Academia" },
          { query: "dark academia tie", aesthetic: "Dark Academia" },
          // ── Cottagecore (23) ──
          ...
          { query: "cottagecore apron dress", aesthetic: "Cottagecore" },
          { query: "cottagecore lace blouse", aesthetic: "Cottagecore" },
          { query: "cottagecore floral blouse", aesthetic: "Cottagecore" },
          { query: "cottagecore smock dress", aesthetic: "Cottagecore" },
          { query: "cottagecore puff sleeve", aesthetic: "Cottagecore" },
          { query: "cottagecore knit cardigan", aesthetic: "Cottagecore" },
          { query: "cottagecore corset top", aesthetic: "Cottagecore" },
          { query: "cottagecore straw hat", aesthetic: "Cottagecore" },
          { query: "cottagecore mary janes", aesthetic: "Cottagecore" },
          { query: "cottagecore mushroom tee", aesthetic: "Cottagecore" },
          { query: "cottagecore pinafore dress", aesthetic: "Cottagecore" },
          { query: "cottagecore floral maxi", aesthetic: "Cottagecore" },
          { query: "cottagecore gingham dress", aesthetic: "Cottagecore" },
          { query: "cottagecore linen overalls", aesthetic: "Cottagecore" },
          { query: "cottagecore embroidered blouse", aesthetic: "Cottagecore" },
          { query: "cottagecore flowy skirt", aesthetic: "Cottagecore" },
          { query: "cottagecore ruffle hem", aesthetic: "Cottagecore" },
          { query: "cottagecore wicker bag", aesthetic: "Cottagecore" },
          { query: "cottagecore floral hair clip", aesthetic: "Cottagecore" },
          // ── Techwear (23) ──
          ...
          { query: "techwear cargo pants", aesthetic: "Techwear" },
          { query: "techwear black jacket", aesthetic: "Techwear" },
          { query: "techwear tactical pants", aesthetic: "Techwear" },
          { query: "techwear hoodie", aesthetic: "Techwear" },
          { query: "techwear boots", aesthetic: "Techwear" },
          { query: "techwear shoulder bag", aesthetic: "Techwear" },
          { query: "techwear zip up", aesthetic: "Techwear" },
          { query: "techwear long coat", aesthetic: "Techwear" },
          { query: "techwear ripstop pants", aesthetic: "Techwear" },
          { query: "techwear balaclava", aesthetic: "Techwear" },
          { query: "techwear gloves", aesthetic: "Techwear" },
          { query: "techwear reflective jacket", aesthetic: "Techwear" },
          { query: "techwear utility shorts", aesthetic: "Techwear" },
          { query: "techwear shell jacket", aesthetic: "Techwear" },
          { query: "techwear harness", aesthetic: "Techwear" },
          { query: "techwear combat boots", aesthetic: "Techwear" },
          { query: "techwear track pants", aesthetic: "Techwear" },
          { query: "techwear black tee", aesthetic: "Techwear" },
          { query: "techwear parachute pants", aesthetic: "Techwear" },
          { query: "techwear streetwear black", aesthetic: "Techwear" },
          // ── Vintage (23) ──
          ...
          { query: "vintage 80s windbreaker", aesthetic: "Vintage" },
          { query: "vintage polo ralph lauren", aesthetic: "Vintage" },
          { query: "vintage mom jeans", aesthetic: "Vintage" },
          { query: "vintage leather jacket", aesthetic: "Vintage" },
          { query: "vintage tommy hilfiger", aesthetic: "Vintage" },
          { query: "vintage flannel shirt", aesthetic: "Vintage" },
          { query: "vintage graphic sweatshirt", aesthetic: "Vintage" },
          { query: "vintage 90s windbreaker", aesthetic: "Vintage" },
          { query: "vintage western shirt", aesthetic: "Vintage" },
          { query: "vintage slip dress", aesthetic: "Vintage" },
          { query: "vintage levi shorts", aesthetic: "Vintage" },
          { query: "vintage adidas jacket", aesthetic: "Vintage" },
          { query: "vintage turtleneck", aesthetic: "Vintage" },
          { query: "vintage blazer 90s", aesthetic: "Vintage" },
          { query: "vintage plaid shirt", aesthetic: "Vintage" },
          { query: "vintage track pants", aesthetic: "Vintage" },
          { query: "vintage knit cardigan", aesthetic: "Vintage" },
          { query: "vintage bucket hat", aesthetic: "Vintage" },
          { query: "vintage henley shirt", aesthetic: "Vintage" },
          // ── Boho (23) ──
          { query: "boho maxi dress", aesthetic: "Boho" },
          { query: "boho crochet top", aesthetic: "Boho" },
          { query: "boho wrap skirt", aesthetic: "Boho" },
          { query: "boho fringe jacket", aesthetic: "Boho" },
          { query: "boho floral blouse", aesthetic: "Boho" },
          { query: "boho wide brim hat", aesthetic: "Boho" },
          { query: "boho lace dress", aesthetic: "Boho" },
          { query: "boho embroidered top", aesthetic: "Boho" },
          { query: "boho tiered skirt", aesthetic: "Boho" },
          { query: "boho suede boots", aesthetic: "Boho" },
          { query: "boho crochet cardigan", aesthetic: "Boho" },
          { query: "boho peasant blouse", aesthetic: "Boho" },
          { query: "boho midi dress floral", aesthetic: "Boho" },
          { query: "boho kimono", aesthetic: "Boho" },
          { query: "boho wrap pants", aesthetic: "Boho" },
          { query: "boho printed maxi", aesthetic: "Boho" },
          { query: "boho patchwork jeans", aesthetic: "Boho" },
          { query: "boho halter dress", aesthetic: "Boho" },
          { query: "boho layered necklace", aesthetic: "Boho" },
          { query: "boho fringe bag", aesthetic: "Boho" },
          { query: "boho ankle boots", aesthetic: "Boho" },
          { query: "boho off shoulder top", aesthetic: "Boho" },
          { query: "boho linen pants", aesthetic: "Boho" },
          // ── Grunge (23) ──
          ...
          { query: "grunge band tee", aesthetic: "Grunge" },
          { query: "grunge leather jacket", aesthetic: "Grunge" },
          { query: "grunge plaid skirt", aesthetic: "Grunge" },
          { query: "grunge black jeans", aesthetic: "Grunge" },
          { query: "grunge oversized hoodie", aesthetic: "Grunge" },
          { query: "grunge mesh top", aesthetic: "Grunge" },
          { query: "grunge fishnet tights", aesthetic: "Grunge" },
          { query: "grunge doc martens", aesthetic: "Grunge" },
          { query: "grunge slip dress", aesthetic: "Grunge" },
          { query: "grunge cargo pants", aesthetic: "Grunge" },
          { query: "grunge choker", aesthetic: "Grunge" },
          { query: "grunge distressed sweater", aesthetic: "Grunge" },
          { query: "grunge crop top", aesthetic: "Grunge" },
          { query: "grunge army jacket", aesthetic: "Grunge" },
          { query: "grunge beanie", aesthetic: "Grunge" },
          { query: "grunge chain belt", aesthetic: "Grunge" },
          { query: "grunge ripped tee", aesthetic: "Grunge" },
          { query: "grunge black mini skirt", aesthetic: "Grunge" },
          { query: "grunge thermal shirt", aesthetic: "Grunge" },
          { query: "grunge graphic tee", aesthetic: "Grunge" },
          // ── Old Money (23) ──
          ...
          { query: "old money loafers", aesthetic: "Old Money" },
          { query: "old money trench coat", aesthetic: "Old Money" },
          { query: "old money polo shirt", aesthetic: "Old Money" },
          { query: "old money tennis skirt", aesthetic: "Old Money" },
          { query: "old money cable knit", aesthetic: "Old Money" },
          { query: "old money white shirt", aesthetic: "Old Money" },
          { query: "old money pearl necklace", aesthetic: "Old Money" },
          { query: "old money pleated skirt", aesthetic: "Old Money" },
          { query: "old money wool coat", aesthetic: "Old Money" },
          { query: "old money leather belt", aesthetic: "Old Money" },
          { query: "old money navy blazer", aesthetic: "Old Money" },
          { query: "old money linen suit", aesthetic: "Old Money" },
          { query: "old money riding boots", aesthetic: "Old Money" },
          { query: "old money plaid blazer", aesthetic: "Old Money" },
          { query: "old money cardigan", aesthetic: "Old Money" },
          { query: "old money structured bag", aesthetic: "Old Money" },
          { query: "old money turtleneck", aesthetic: "Old Money" },
          { query: "old money dress pants", aesthetic: "Old Money" },
          { query: "old money midi dress", aesthetic: "Old Money" },
          // ── E-Girl (23) ──
          ...
          { query: "egirl chain necklace", aesthetic: "E-Girl" },
          { query: "egirl striped long sleeve", aesthetic: "E-Girl" },
          { query: "egirl graphic tee", aesthetic: "E-Girl" },
          { query: "egirl fishnet tights", aesthetic: "E-Girl" },
          { query: "egirl corset top", aesthetic: "E-Girl" },
          { query: "egirl black mini skirt", aesthetic: "E-Girl" },
          { query: "egirl hair clips", aesthetic: "E-Girl" },
          { query: "egirl oversized hoodie", aesthetic: "E-Girl" },
          { query: "egirl thigh high socks", aesthetic: "E-Girl" },
          { query: "egirl crop top", aesthetic: "E-Girl" },
          { query: "egirl plaid pants", aesthetic: "E-Girl" },
          { query: "egirl buckle boots", aesthetic: "E-Girl" },
          { query: "egirl beaded bracelet", aesthetic: "E-Girl" },
          { query: "egirl grunge skirt", aesthetic: "E-Girl" },
          { query: "egirl emo tee", aesthetic: "E-Girl" },
          { query: "egirl studded belt", aesthetic: "E-Girl" },
          { query: "egirl velvet top", aesthetic: "E-Girl" },
          { query: "egirl zip hoodie", aesthetic: "E-Girl" },
          { query: "egirl chain belt", aesthetic: "E-Girl" },
          { query: "egirl doc martens", aesthetic: "E-Girl" },
          // ── Soft Girl (23) ──
          ...
          { query: "soft girl pink top", aesthetic: "Soft Girl" },
          { query: "soft girl bow hair clip", aesthetic: "Soft Girl" },
          { query: "soft girl pastel skirt", aesthetic: "Soft Girl" },
          { query: "soft girl mini dress", aesthetic: "Soft Girl" },
          { query: "soft girl floral dress", aesthetic: "Soft Girl" },
          { query: "soft girl pastel sweater", aesthetic: "Soft Girl" },
          { query: "soft girl mary janes", aesthetic: "Soft Girl" },
          { query: "soft girl butterfly top", aesthetic: "Soft Girl" },
          { query: "soft girl ruffle blouse", aesthetic: "Soft Girl" },
          { query: "soft girl pastel cardigan", aesthetic: "Soft Girl" },
          { query: "soft girl floral midi", aesthetic: "Soft Girl" },
          { query: "soft girl pink jeans", aesthetic: "Soft Girl" },
          { query: "soft girl puff sleeve", aesthetic: "Soft Girl" },
          { query: "soft girl knit vest", aesthetic: "Soft Girl" },
          { query: "soft girl pearl earrings", aesthetic: "Soft Girl" },
          { query: "soft girl cloud top", aesthetic: "Soft Girl" },
          { query: "soft girl pastel shorts", aesthetic: "Soft Girl" },
          { query: "soft girl lace trim top", aesthetic: "Soft Girl" },
          { query: "soft girl checkered set", aesthetic: "Soft Girl" },
          { query: "soft girl preppy outfit", aesthetic: "Soft Girl" },
          // ── Skater (23) ──
          ...
          { query: "skater cargo shorts", aesthetic: "Skater" },
          { query: "skater hoodie", aesthetic: "Skater" },
          { query: "skater flannel shirt", aesthetic: "Skater" },
          { query: "skater graphic tee", aesthetic: "Skater" },
          { query: "skater beanie", aesthetic: "Skater" },
          { query: "skater windbreaker", aesthetic: "Skater" },
          { query: "skater nike sb", aesthetic: "Skater" },
          { query: "skater converse", aesthetic: "Skater" },
          { query: "skater zip hoodie", aesthetic: "Skater" },
          { query: "skater band tee", aesthetic: "Skater" },
          { query: "skater baggy shorts", aesthetic: "Skater" },
          { query: "skater five panel hat", aesthetic: "Skater" },
          { query: "skater crewneck", aesthetic: "Skater" },
          { query: "skater long sleeve tee", aesthetic: "Skater" },
          { query: "skater dickies pants", aesthetic: "Skater" },
          { query: "skater bucket hat", aesthetic: "Skater" },
          { query: "skater polo shirt", aesthetic: "Skater" },
          { query: "skater jean jacket", aesthetic: "Skater" },
          { query: "skater cargo pants", aesthetic: "Skater" },
          { query: "skater slip on vans", aesthetic: "Skater" },
          // ── Coastal Grandmother (23) ──
          ...
          { query: "coastal grandmother linen dress", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother wide brim hat", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother white jeans", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother woven bag", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother silk scarf", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother loafers", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother nautical top", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother espadrilles", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother linen blazer", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother maxi skirt", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother cream sweater", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother cotton dress", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother pearl earrings", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother white blouse", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother khaki pants", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother slip on mules", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother neutral cardigan", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother boat neck top", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother striped dress", aesthetic: "Coastal Grandmother" },
          { query: "coastal grandmother linen jumpsuit", aesthetic: "Coastal Grandmother" },
          // ── Coquette (23) ──
          ...
          { query: "coquette pink mini dress", aesthetic: "Coquette" },
          { query: "coquette ribbon hair bow", aesthetic: "Coquette" },
          { query: "coquette corset top", aesthetic: "Coquette" },
          { query: "coquette satin dress", aesthetic: "Coquette" },
          { query: "coquette ruffle blouse", aesthetic: "Coquette" },
          { query: "coquette pink cardigan", aesthetic: "Coquette" },
          { query: "coquette pearl accessories", aesthetic: "Coquette" },
          { query: "coquette floral mini skirt", aesthetic: "Coquette" },
          { query: "coquette lace trim dress", aesthetic: "Coquette" },
          { query: "coquette bow heels", aesthetic: "Coquette" },
          { query: "coquette babydoll dress", aesthetic: "Coquette" },
          { query: "coquette pink bow top", aesthetic: "Coquette" },
          { query: "coquette tulle skirt", aesthetic: "Coquette" },
          { query: "coquette velvet headband", aesthetic: "Coquette" },
          { query: "coquette lacy slip dress", aesthetic: "Coquette" },
          { query: "coquette embroidered top", aesthetic: "Coquette" },
          { query: "coquette bow socks", aesthetic: "Coquette" },
          { query: "coquette pink blazer", aesthetic: "Coquette" },
          { query: "coquette mary jane heels", aesthetic: "Coquette" },
          { query: "coquette floral hair clip", aesthetic: "Coquette" },
        ];
        ...
        // 4. Run sequentially in batches of 8 to avoid Apify rate limits, 10 items each
        let seeded = 0;
        for (const { query, aesthetic } of allQueries) {
          const r = await fetchDepopListings(query, aesthetic, 10, true).catch(() => []);
          if (r.length) seeded++;
