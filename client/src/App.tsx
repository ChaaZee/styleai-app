...
function AppContent() {
  ...
  return (
    <div className="bg-background text-foreground flex flex-col" style={{ height: "100dvh" }}>
      ...
      <main className={isQuizRoute ? "flex-1 overflow-auto" : isDiscoverRoute ? "flex-1 flex flex-col relative overflow-hidden" : "flex-1 overflow-auto"} style={isDiscoverRoute ? {} : { paddingBottom: "64px" }}>
        <Switch>
